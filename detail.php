...
$item->picture_url = 'https://viccab5-mp-commerce-php.herokuapp.com'.$_POST['img'];
$item->quantity = $_POST['unit'];
$item->unit_price = $_POST['price'];
$preference->items = array($item);

// Número de orden del pedido con correo
$preference->external_reference = 'cabrerabravov@gmail.com';
...
$preference->back_urls = array(
    "success" => "https://viccab5-mp-commerce-php.herokuapp.com/success.php",
    "failure" => "https://viccab5-mp-commerce-php.herokuapp.com/failure.php",
    "pending" => "https://viccab5-mp-commerce-php.herokuapp.com/pending.php"
);
$preference->auto_return = "approved";

$preference->notification_url = "https://viccab5-mp-commerce-php.herokuapp.com/notificacion.php?source_news=webhooks";
    $preference->save();
?>
